...
## 2.1 Add modules
## 
golem::add_module( name = "create_intervals" ) # Name of the module
golem::add_module( name = "my_other_module" ) # Name of the module

## 2.2 Add dependencies

usethis::use_package( "tibble" ) # To call each time you need a new package
...
## 3.1 Vignette
usethis::use_vignette("IntervalsDemo")
